...
class Adapter_TraversableTest extends \PHPUnit_Framework_TestCase
{
	...
	public function testSimpleAdaptation()
	{
		...
		$ul->innertext .= $adapted; //appendChild($adapted);
//		$this->assertInstanceOf('DOMDocumentFragment', $adapted); // this test is too specific hence obsolete
...
/**
	...
	public function testMultipleAdaptations($tag, $injector, $finalString)
	{
		...
		$this->assertContains($finalString, $this->dom->save()); //Xml());
		$this->dom->clear();
	}
